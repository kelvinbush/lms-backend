...
export function mapLoanApplicationDetail(
  ...
  return {
    ...
    amountDisbursed: row.amountDisbursed ? (toNumber(row.amountDisbursed) ?? null) : null,
    disbursementReceiptUrl: row.disbursementReceiptUrl ?? null,
    disbursedBy: row.disbursedBy ?? undefined,
    eligibilityAssessmentComment: row.eligibilityAssessmentComment ?? null,
    creditAssessmentComment: row.creditAssessmentComment ?? null,
    headOfCreditReviewComment: row.headOfCreditReviewComment ?? null,
    internalApprovalCeoComment: row.internalApprovalCeoComment ?? null,
    createdAt: row.createdAt.toISOString(),
    updatedAt: row.updatedAt.toISOString(),
