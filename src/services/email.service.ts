...
export class EmailService {
  ...
  async sendLoanStageReviewNotificationEmail(
    params: LoanStageReviewNotificationEmailData
  ): Promise<{
    success: boolean;
    messageId?: string;
    error?: string;
  ...
  async sendDocumentGenerationNotificationEmail(
    params: DocumentGenerationNotificationEmailData
  ): Promise<{
    success: boolean;
    messageId?: string;
    error?: string;
  ...
  async sendTermSheetApprovalNotificationEmail(
    params: TermSheetApprovalNotificationEmailData
  ): Promise<{
    success: boolean;
    messageId?: string;
    error?: string;
