  ...
  return (
    ...
    >
      ...
      <Text style={paragraph}>
        ...
        <a href={`mailto:${supportEmail}`} style={link}><span style={boldText}>{supportEmail}</span></a>
        {' '}or call us at{' '}
        <a href={`tel:${supportPhone.replace(/\s/g, '')}`} style={link}><span style={boldText}>{supportPhone}</span></a>
      </Text>
    </BaseTemplate>
  );
}
