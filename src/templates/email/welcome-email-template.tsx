...
export default function WelcomeEmailTemplate({
  ...
  return (
    ...
    >
      ...
      <Text style={sectionHeading}>Everything You Need to Know About Your Finances</Text>
      <Text style={paragraph}>
        From insights on cash flows to funding opportunities, savings products, and loans, we've got
        you covered.
      </Text>

      <Text style={sectionHeading}>Turning Good Deeds into Great Rewards</Text>
      <Text style={paragraph}>
        The greener your actions, the more benefits you unlock. Climate action has never been more
        rewarding!
      </Text>

      <Text style={sectionHeading}>We Leave Nobody Behind</Text>
      <Text style={paragraph}>
      ...
      <Text style={sectionHeading}>Your First Step:</Text>
      <Text style={paragraph}>
