...
export default function AccountDeactivationTemplate({
  ...
  return (
    <BaseTemplate
      ...
      firstName={firstName}
    >
      <Text style={paragraph}>We hope you're doing well.</Text>

      <Text style={paragraph}>
        We regret to inform you that your Melanin Kapital account has been{" "}
        <span style={boldText}>deactivated</span>. This may be due to security reasons, policy
        compliance, or other administrative actions.
      </Text>
