  ...
  return (
    ...
    >
      ...
      <Text style={paragraph}>
        A loan request has moved to the <strong>Document Generation</strong> stage and requires
        your attention. Below are the applicant's details and a summary of their loan request:
      </Text>
      ...
      <Section style={section}>
        ...
        {approvedCreditLimit && (
          <Text style={detailLine}>✅ <strong>Approved Credit Limit:</strong> {approvedCreditLimit}</Text>
        )}
        {approvedLoanTenure && (
          <Text style={detailLine}>✅ <strong>Approved Loan Tenure:</strong> {approvedLoanTenure}</Text>
        )}
      ...
      <Section style={section}>
        ...
        <Text style={paragraph}>
          To view the full details and take the required action, please log in to the Admin Platform below:
        </Text>
