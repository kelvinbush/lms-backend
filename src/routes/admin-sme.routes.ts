...
export async function adminSMERoutes(fastify: FastifyInstance) {
      ...
      try {
        ...
        const details = buildAuditDetails(request.body, {
          ...
          computed: [
            {
              key: "hasIdNumber",
              value: !!request.body.idNumber,
              condition: (src) => "idNumber" in src,
            },
            {
              key: "hasTaxNumber",
              value: !!request.body.taxNumber,
              condition: (src) => "taxNumber" in src,
            },
          ],
        });
    ...
    async (
      ...
      try {
        ...
        const details = buildAuditDetails(request.body, {
          ...
          computed: [
            {
              key: "hasDefaultReason",
              value: !!request.body.defaultReason,
              condition: (src) => "defaultReason" in src,
            },
          ],
        });
  ...
  fastify.post(
    ...
    async (
      request: FastifyRequest<{ Body: AdminSMEModel.Step1UserInfoBody }>,
      reply: FastifyReply
    ) => {
      try {
  ...
  fastify.put(
    ...
    async (
      request: FastifyRequest<{
        Params: { userId: string };
        Body: AdminSMEModel.Step1UserInfoBody;
      }>,
      reply: FastifyReply
    ) => {
      try {
  ...
  fastify.put(
    ...
    async (
      request: FastifyRequest<{
        Params: { userId: string };
        Body: AdminSMEModel.Step2BusinessBasicInfoBody;
      }>,
      reply: FastifyReply
    ) => {
      try {
          ...
          computed: [
            {
              ...
              condition: (src) => "description" in src,
            },
            {
              key: "hasWebsite",
              value: !!request.body.website,
              condition: (src) => "website" in src,
            },
            { key: "hasLogo", value: !!request.body.logo, condition: (src) => "logo" in src },
            {
              key: "videoLinkCount",
              value: request.body.videoLinks?.length || 0,
              condition: (src) => "videoLinks" in src,
            },
            {
              key: "businessPhotoCount",
              value: request.body.businessPhotos?.length || 0,
              condition: (src) => "businessPhotos" in src,
            },
          ],
        });
  ...
  fastify.put(
    ...
    async (
      request: FastifyRequest<{
        Params: { userId: string };
        Body: AdminSMEModel.Step3LocationInfoBody;
      }>,
      reply: FastifyReply
    ) => {
      try {
        ...
        const details = buildAuditDetails(request.body, {
          ...
          computed: [
            {
              key: "hasRegisteredOfficeAddress",
              value: !!request.body.registeredOfficeAddress,
              condition: (src) => "registeredOfficeAddress" in src,
            },
          ],
        });
  ...
  fastify.put(
    ...
    async (
      request: FastifyRequest<{
        Params: { userId: string };
        Body: AdminSMEModel.Step4PersonalDocumentsBody;
      }>,
      reply: FastifyReply
    ) => {
      try {
        await requireRole(request, "member");
        const result = await AdminSMEService.savePersonalDocuments(
          request.params.userId,
          request.body
        );
        ...
        const details = buildAuditDetails(request.body, {
          ...
          computed: [
            {
              key: "documentCount",
              value: request.body.documents?.length || 0,
              condition: (src) => "documents" in src,
            },
            {
              key: "documentTypes",
              value: request.body.documents?.map((d) => d.docType) || [],
              condition: (src) => "documents" in src,
            },
            {
              key: "hasIdNumber",
  ...
  fastify.put(
    ...
    async (
      request: FastifyRequest<{
        Params: { userId: string };
        Body: AdminSMEModel.Step5CompanyInfoDocumentsBody;
      }>,
      reply: FastifyReply
    ) => {
      try {
        await requireRole(request, "member");
        const result = await AdminSMEService.saveCompanyInfoDocuments(
          request.params.userId,
          request.body
        );
        ...
        const details = buildAuditDetails(request.body, {
          computed: [
            ...
            {
              key: "passwordProtectedCount",
              value: request.body.documents?.filter((d) => d.isPasswordProtected).length || 0,
              condition: (src) => "documents" in src,
            },
          ],
        });
  ...
  fastify.put(
    ...
    async (
      request: FastifyRequest<{
        Params: { userId: string };
        Body: AdminSMEModel.Step6FinancialDocumentsBody;
      }>,
      reply: FastifyReply
    ) => {
      try {
        await requireRole(request, "member");
        const result = await AdminSMEService.saveFinancialDocuments(
          request.params.userId,
          request.body
        );
        ...
        const details = buildAuditDetails(request.body, {
          computed: [
            ...
            {
              key: "hasBankName",
              value: request.body.documents?.some((d) => d.docBankName) || false,
              condition: (src) => "documents" in src,
            },
            {
              key: "hasYear",
              value: request.body.documents?.some((d) => d.docYear) || false,
              condition: (src) => "documents" in src,
            },
          ],
        });
  ...
  fastify.put(
    ...
    async (
      request: FastifyRequest<{
        Params: { userId: string };
        Body: AdminSMEModel.Step7PermitAndPitchDocumentsBody;
      }>,
      reply: FastifyReply
    ) => {
      try {
        await requireRole(request, "member");
        const result = await AdminSMEService.savePermitAndPitchDocuments(
          request.params.userId,
          request.body
        );
  ...
  fastify.get(
    ...
    async (request: FastifyRequest<{ Params: { userId: string } }>, reply: FastifyReply) => {
      try {
        ...
        const status = error?.status || 500;
        logger.error("[AdminSME Routes] Error getting personal documents", {
          error: error?.message,
        });
        return reply.code(status).send({
          error: error?.message || "Internal error",
  ...
  fastify.get(
    ...
    async (request: FastifyRequest<{ Params: { userId: string } }>, reply: FastifyReply) => {
      try {
        ...
        const status = error?.status || 500;
        logger.error("[AdminSME Routes] Error getting business documents", {
          error: error?.message,
        });
        return reply.code(status).send({
          error: error?.message || "Internal error",
  ...
  fastify.get(
    ...
    async (
      ...
      try {
        await requireRole(request, "member");
        const result = await AdminSMEService.getAuditTrail(request.params.userId, request.query);
        return reply.send(result);
      } catch (error: any) {
        const status = error?.status || 500;
  ...
  fastify.post(
    ...
    async (request: FastifyRequest<{ Params: { userId: string } }>, reply: FastifyReply) => {
      try {
        const _current = await requireRole(request, "member");
        ...
        logAdminAction(
          ...
          isResend
            ? `Resent invitation to SME user (${smeEmail})`
            : `Sent invitation to SME user (${smeEmail})`,
          {
